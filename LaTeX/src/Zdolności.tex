...
\begin{itemize}
\item Procesor Akcji
\item Agent-Prowokator
\item Zwierzęce Zmysły
\item Sprawny Oszust
\item Powłoka Ciemnej Materii
\item Ulepszenie Siły
\item Doświadczony Kierowca
\item Ekspert-Pilot
\item Odnalezienie Winnych
...
\item Improwizacja
\item Determinacja
\item Inteligentny Interfejs
\item Intensywna Interakcja
\item Wiedza to Potęga
\item Mistrzowski Rzemieślnik
\item Szczegółowe Planowanie
\item Mniejsze Życzenie
\item Nocne Uderzenie
\item Wytrzymalszy Niż Wróg
\item Niedzielny Mechanik
\item Wyczulone Zmysły
\item Niezłe Oszustwo
\item Szybka Reakcja
\item Jeździec
\item Morskie Nogi
\item Pakiet Sensoryczny
\item Celowanie Serv-0
\item Serv-0 Wojownik
\item Bystrooki
\item Obeznanie ze Statkiem Kosmicznym
\item Cichy Jak Kosmos
\item Umiejętny Atak
\item Ukojenie Ciała i Umysłu
\item Ciche Kroki
\item Sokole Oko
\item Specjalizacja w Zadaniu
\item Rozmowny
\item Przyspieszenie Czasoprzestrzenne
\item Wyszkolony Miażdżyciel
\item Wyszkolony Rewolwerowiec
\item Wyszkolony Morderca
\item Konfuzja Słowem
\item Dobrze Wykształcony
\end{itemize}
...
\subsection{Transformacja}\index{Zdolności!Kategorie!Transformacja}
