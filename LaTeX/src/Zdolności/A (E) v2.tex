...
\myability{Mrożący Dotyk} (4 punkty Intelektu) - Twoje ręce stają się tak bardzo zimne, że Twój dotyk zamraża żyjący cel Twojego rozmiaru lub mniejszy, przytrzymując go w miejscu na jedną rundę. Jeśli masz inną zdolność mrozu aktywowana przez dotyk (taką jak np: Lodowy Dotyk) możesz z niej skorzystać jako z cześći swojego Mrożącego Dotyku. Akcja.
