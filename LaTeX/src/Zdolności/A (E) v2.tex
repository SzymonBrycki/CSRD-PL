...
\myability{Wierny Obrońca} (2 punkty Mocy lub Intelektu) - Wybierz jedną postać, którą widzisz. Ta postać zostaje pod Twoją obroną. Jesteś wyszkolony we wszelkich akcjach, by ją znalexć, leczyć, wchodzić w interakcję i chronić. Możesz mieć tylko jedną postać pod swoją obroną w danym czasie. Akcja, by rozpocząć.
...
\myability{Interfejs Zasięgowy} (2 punkty Intelektu) - Możesz aktywować, deaktywować lub kontrolować maszynę na dalekim zasięgu tak, jakbyś stał obok niej, nawet jeśli normalnie wymaga dotyku. Jeśli nigdy wcześniej nie miałek kontaktu z daną maszyną, zadanie jest utrudnione o dwa stopnie. By skorzystać z tej zdolności, musisz rozumieć funkcję tej maszyny, musi ona być Twojego rozmiaru lub mniejsza, i nie może być podłączona do innej inteligencji (lub sama być inteligentną). Akcja. 
