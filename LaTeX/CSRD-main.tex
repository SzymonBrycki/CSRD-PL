...
\newcommand{\myability }[1] {{\textbf{#1}\index{Zdolności!Alfabetycznie!#1}\label{sec:#1}}}
...
\begin{titlepage}
	...
	\vspace{1cm}
	{\large \itshape Wersja SRD: 2024-09-26 \par}
	...
	\vspace{1cm}
	{\large \textbf{Copyright © 2024 Monte Cook Games. \break Some rights reserved.} \par}
	\vspace{1cm}
...
% HOMEBREW: https://callmepartario.github.io/og-csrd/og-dd.html !!!!!
